"""
Modern ChatService (2025 version)
Stateless core — persistent session state managed externally (DB, Redis, LangGraph)
"""
...
from app.db.session_store import fetch_messages, save_message  # hypothetical persistence
...
Answer thoroughly and suggest 3 follow-up questions (numbered).""",
    ...
    async def chat(self, user_id: str, message: str, session_id: str):
        ...
        try:
            ...
            conversation_history = fetch_messages(session_id, limit=8)
            chat_history_text = "\n".join(
