						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
							{leaderboardData.slice(0, 3).map((user, index) => (
								<Card
									...
									className={`${
										index === 0
											? "md:order-2 border-yellow-500/50 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-950/20 dark:to-orange-950/20"
											: index === 1
											? "md:order-1 border-gray-400/50"
											: "md:order-3 border-amber-600/50"
