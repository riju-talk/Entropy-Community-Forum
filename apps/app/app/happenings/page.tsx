...
const events = [
  ...
  },
  {
    ...
    description: "Hands-on workshop exploring quantum computing principles and practical applications.",
    date: "March 22, 2024",
  ...
  },
  {
    ...
    description: "Discover the latest breakthroughs in biotechnology and their impact on healthcare.",
    date: "April 5, 2024",
  ...
  },
  {
    ...
    description: "Leading climate scientists discuss current research and environmental solutions.",
    date: "April 18, 2024",
  ...
  },
  {
    ...
    description: "Fascinating insights into current space missions and future exploration plans.",
    date: "April 25, 2024",
    ...
    <div className="relative">
      ...
      <div className="space-y-6 filter blur-sm opacity-80 pointer-events-none">
        <div>
          ...
          <p className="text-muted-foreground">Stay updated with the latest academic events, workshops, and conferences</p>
        </div>
